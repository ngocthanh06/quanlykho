    ...
    <div class="ibox-content">
        <form method="post" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" required value="{{$supp->TenNSX}}" name="TenNSX" placeholder="Tên Nhà Cung Cấp" class="form-control">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" required value="{{$supp->address}}" name="address" placeholder="Địa Chỉ Nhà Cung Cấp" class="form-control">
                    <span id="errorSDT" ></span>
                </div>
            </div>

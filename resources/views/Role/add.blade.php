    ...
    <div class="ibox-content">
        <form method="post" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input class="form-control" type="text" placeholder="Tên quyền" name="name" id="">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" name="desc" placeholder="Thêm nội dung phân quyền" cols="30" rows="10"></textarea>
                </div>
            </div>
